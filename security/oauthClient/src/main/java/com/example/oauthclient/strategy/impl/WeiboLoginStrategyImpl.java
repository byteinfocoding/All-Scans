...
import com.example.oauthclient.config.WeiboConfigProperties;
...
import static com.example.oauthclient.enums.StatusCodeEnum.WEIBO_LOGIN_ERROR;
...
public class WeiboLoginStrategyImpl extends AbstractSocialLoginStrategyImpl {
    ...
    private WeiboTokenDTO getWeiboToken(WeiboLoginVO weiBoLoginVO) {
        ...
        try {
            ...
            throw new RuntimeException(WEIBO_LOGIN_ERROR.toString());
        }
    }
